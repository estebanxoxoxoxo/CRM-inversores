...
export const QUERIES = [
  ...
  "Conservative Christian venture capital deep tech Colorado general partner",
  "Conservative Christian venture capital deep tech Louisiana general partner",
  "Conservative Christian venture capital deep tech Alabama general partner",
  "Conservative Christian venture capital deep tech Georgia general partner",
  "Conservative Christian venture capital deep tech South Carolina general partner",
  "Conservative Christian venture capital deep tech North Carolina general partner",
  "Conservative Christian venture capital deep tech Arkansas general partner",
...
"Venture capital deep tech United states partner",
  ...
  "Conservative Christian venture capital deep tech Colorado partner",
  "Conservative Christian venture capital deep tech Louisiana partner",
  "Conservative Christian venture capital deep tech Alabama partner",
  "Conservative Christian venture capital deep tech Georgia partner",
  "Conservative Christian venture capital deep tech South Carolina partner",
  "Conservative Christian venture capital deep tech North Carolina partner",
  "Conservative Christian venture capital deep tech Arkansas partner",
  ...
  "Conservative Christian venture capital deep tech Colorado principal",
  "Conservative Christian venture capital deep tech Louisiana principal",
  "Conservative Christian venture capital deep tech Alabama principal",
  "Conservative Christian venture capital deep tech Georgia principal",
  "Conservative Christian venture capital deep tech South Carolina principal",
  "Conservative Christian venture capital deep tech North Carolina principal",
  "Conservative Christian venture capital deep tech Arkansas principal",
  ...
  "Conservative Christian Fund capital deep tech Colorado",
  "Conservative Christian Fund capital deep tech Louisiana",
  "Conservative Christian Fund capital deep tech Alabama",
  "Conservative Christian Fund capital deep tech Georgia",
  "Conservative Christian Fund capital deep tech South Carolina",
  "Conservative Christian Fund capital deep tech North Carolina",
  "Conservative Christian Fund capital deep tech Arkansas",
  ...
  "Conservador cristiano inversor angel deep tech Colorado",
  "Conservador cristiano inversor angel deep tech Luisiana",
  "Conservador cristiano inversor angel deep tech Alabama",
  "Conservador cristiano inversor angel deep tech Georgia",
  "Conservador cristiano inversor angel deep tech Carolina del Sur",
  "Conservador cristiano inversor angel deep tech Carolina del Norte",
  "Conservador cristiano inversor angel deep tech Arkansas",
  ...
  "Conservative Christian angel investor deep tech Colorado",
  "Conservative Christian angel investor deep tech Louisiana",
  "Conservative Christian angel investor deep tech Alabama",
  "Conservative Christian angel investor deep tech Georgia",
  "Conservative Christian angel investor deep tech South Carolina",
  "Conservative Christian angel investor deep tech North Carolina",
  "Conservative Christian angel investor deep tech Arkansas",
  ...
  "Conservative Christian venture capital dev tools Colorado general partner",
  "Conservative Christian venture capital dev tools Louisiana general partner",
  "Conservative Christian venture capital dev tools Alabama general partner",
  "Conservative Christian venture capital dev tools Georgia general partner",
  "Conservative Christian venture capital dev tools South Carolina general partner",
  "Conservative Christian venture capital dev tools North Carolina general partner",
  "Conservative Christian venture capital dev tools Arkansas general partner",
 ...
 "Venture capital dev tools Estados unidos partner",
  ...
  "Conservative Christian venture capital dev tools Colorado partner",
  "Conservative Christian venture capital dev tools Louisiana partner",
  "Conservative Christian venture capital dev tools Alabama partner",
  "Conservative Christian venture capital dev tools Georgia partner",
  "Conservative Christian venture capital dev tools South Carolina partner",
  "Conservative Christian venture capital dev tools North Carolina partner",
  "Conservative Christian venture capital dev tools Arkansas partner",
  ...
  "Conservative Christian venture capital dev tools Colorado principal",
  "Conservative Christian venture capital dev tools Louisiana principal",
  "Conservative Christian venture capital dev tools Alabama principal",
  "Conservative Christian venture capital dev tools Georgia principal",
  "Conservative Christian venture capital dev tools South Carolina principal",
  "Conservative Christian venture capital dev tools North Carolina principal",
  "Conservative Christian venture capital dev tools Arkansas principal",
  ...
  "Conservative Christian Fund capital dev tools Colorado",
  "Conservative Christian Fund capital dev tools Louisiana",
  "Conservative Christian Fund capital dev tools Alabama",
  "Conservative Christian Fund capital dev tools Georgia",
  "Conservative Christian Fund capital dev tools South Carolina",
  "Conservative Christian Fund capital dev tools North Carolina",
  "Conservative Christian Fund capital dev tools Arkansas",
  ...
  "Conservador cristiano inversor angel dev tools Colorado",
  "Conservador cristiano inversor angel dev tools Luisiana",
  "Conservador cristiano inversor angel dev tools Alabama",
  "Conservador cristiano inversor angel dev tools Georgia",
  "Conservador cristiano inversor angel dev tools Carolina del Sur",
  "Conservador cristiano inversor angel dev tools Carolina del Norte",
  "Conservador cristiano inversor angel dev tools Arkansas",
  ...
  "Conservative Christian angel investor dev tools Colorado",
  "Conservative Christian angel investor dev tools Louisiana",
  "Conservative Christian angel investor dev tools Alabama",
  "Conservative Christian angel investor dev tools Georgia",
  "Conservative Christian angel investor dev tools South Carolina",
  "Conservative Christian angel investor dev tools North Carolina",
  "Conservative Christian angel investor dev tools Arkansas",
  ...
  "Conservative Christian venture capital developer tools Colorado general partner",
  "Conservative Christian venture capital developer tools Louisiana general partner",
  "Conservative Christian venture capital developer tools Alabama general partner",
  "Conservative Christian venture capital developer tools Georgia general partner",
  "Conservative Christian venture capital developer tools South Carolina general partner",
  "Conservative Christian venture capital developer tools North Carolina general partner",
  "Conservative Christian venture capital developer tools Arkansas general partner",
 ...
 "Venture capital developer tools Estados unidos partner",
  ...
  "Conservative Christian venture capital developer tools Colorado partner",
  "Conservative Christian venture capital developer tools Louisiana partner",
  "Conservative Christian venture capital developer tools Alabama partner",
  "Conservative Christian venture capital developer tools Georgia partner",
  "Conservative Christian venture capital developer tools South Carolina partner",
  "Conservative Christian venture capital developer tools North Carolina partner",
  "Conservative Christian venture capital developer tools Arkansas partner",
  ...
  "Conservative Christian venture capital developer tools Colorado principal",
  "Conservative Christian venture capital developer tools Louisiana principal",
  "Conservative Christian venture capital developer tools Alabama principal",
  "Conservative Christian venture capital developer tools Georgia principal",
  "Conservative Christian venture capital developer tools South Carolina principal",
  "Conservative Christian venture capital developer tools North Carolina principal",
  "Conservative Christian venture capital developer tools Arkansas principal",
  ...
  "Conservative Christian Fund capital developer tools Colorado",
  "Conservative Christian Fund capital developer tools Louisiana",
  "Conservative Christian Fund capital developer tools Alabama",
  "Conservative Christian Fund capital developer tools Georgia",
  "Conservative Christian Fund capital developer tools South Carolina",
  "Conservative Christian Fund capital developer tools North Carolina",
  "Conservative Christian Fund capital developer tools Arkansas",
  ...
  "Conservador cristiano inversor angel developer tools Colorado",
  "Conservador cristiano inversor angel developer tools Luisiana",
  "Conservador cristiano inversor angel developer tools Alabama",
  "Conservador cristiano inversor angel developer tools Georgia",
  "Conservador cristiano inversor angel developer tools Carolina del Sur",
  "Conservador cristiano inversor angel developer tools Carolina del Norte",
  "Conservador cristiano inversor angel developer tools Arkansas",
  ...
  "Conservative Christian venture capital infra IA Colorado general partner",
  "Conservative Christian venture capital infra IA Louisiana general partner",
  "Conservative Christian venture capital infra IA Alabama general partner",
  "Conservative Christian venture capital infra IA Georgia general partner",
  "Conservative Christian venture capital infra IA South Carolina general partner",
  "Conservative Christian venture capital infra IA North Carolina general partner",
  "Conservative Christian venture capital infra IA Arkansas general partner",
 ...
 "Venture capital infra IA tools Estados unidos partner",
  ...
  "Conservative Christian venture capital infra IA Colorado partner",
  "Conservative Christian venture capital infra IA Louisiana partner",
  "Conservative Christian venture capital infra IA Alabama partner",
  "Conservative Christian venture capital infra IA Georgia partner",
  "Conservative Christian venture capital infra IA South Carolina partner",
  "Conservative Christian venture capital infra IA North Carolina partner",
  "Conservative Christian venture capital infra IA Arkansas partner",
  ...
  "Conservative Christian venture capital infra IA Colorado principal",
  "Conservative Christian venture capital infra IA Louisiana principal",
  "Conservative Christian venture capital infra IA Alabama principal",
  "Conservative Christian venture capital infra IA Georgia principal",
  "Conservative Christian venture capital infra IA South Carolina principal",
  "Conservative Christian venture capital infra IA North Carolina principal",
  "Conservative Christian venture capital infra IA Arkansas principal",
  ...
  "Conservative Christian Fund capital infra IA Colorado",
  "Conservative Christian Fund capital infra IA Louisiana",
  "Conservative Christian Fund capital infra IA Alabama",
  "Conservative Christian Fund capital infra IA Georgia",
  "Conservative Christian Fund capital infra IA South Carolina",
  "Conservative Christian Fund capital infra IA North Carolina",
  "Conservative Christian Fund capital infra IA Arkansas",
  ...
  "Conservador cristiano inversor angel infra IA Colorado",
  "Conservador cristiano inversor angel infra IA Luisiana",
  "Conservador cristiano inversor angel infra IA Alabama",
  "Conservador cristiano inversor angel infra IA Georgia",
  "Conservador cristiano inversor angel infra IA Carolina del Sur",
  "Conservador cristiano inversor angel infra IA Carolina del Norte",
  "Conservador cristiano inversor angel infra IA Arkansas",
  ...
  "Conservative Christian angel investor infra IA Colorado",
  "Conservative Christian angel investor infra IA Louisiana",
  "Conservative Christian angel investor infra IA Alabama",
  "Conservative Christian angel investor infra IA Georgia",
  "Conservative Christian angel investor infra IA South Carolina",
  "Conservative Christian angel investor infra IA North Carolina",
  "Conservative Christian angel investor infra IA Arkansas",
  "Conservative Christian angel investor infra IA Colorado",
  "Conservative Christian angel investor infra IA Louisiana",
  "Conservative Christian angel investor infra IA Alabama",
  "Conservative Christian angel investor infra IA Georgia",
...
export const SOURCE_GROUPS: { scope: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "C12 Group, Convene, Halftime Institute y Kingdom Advisors (directorios de miembros y ponentes)",
      ...
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, Colorado Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, Louisiana Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, Alabama Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, Georgia Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, South Carolina Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, North Carolina Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
      "los business journals estatales y sus Book of Lists: D CEO y Texas Monthly, Florida Trend, Atlanta Business Chronicle, Charlotte y Triangle Business Journal, Birmingham Business Journal, Arkansas Business, Arkansas Business, Nevada Business Magazine, Biz New Orleans, Colorado Springs Gazette, Albuquerque Business First",
...
export const FAITH_TYPES = [
  ...
  "Gestoras de inversión bíblicamente responsable (BRI): Timothy Plan (Maitland, Florida), Inspire Investing, Eventide Asset Management, GuideStone Financial Resources (Dallas). Invierten en cotizadas, pero sus fundadores, consejeros y clientes son angels frecuentes.",
  ...
  "Family offices de familias que se declaran cristianas: en Texas, Wilks Brothers (Cisco), Hunt (Dallas), Bass (Fort Worth), CrownQuest y Tim Dunn (Midland), Interstate Batteries y Norm Miller (Dallas); en Arkansas, Walton y Runway Group (Bentonville), Tyson (Springdale), Stephens Inc. (Little Rock), Murphy (El Dorado); en Georgia, la familia Cathy y WinShape; en Alabama, Harbert Management, Drummond y McWane (Birmingham); en las Carolinas, Belk (Charlotte) y el entorno de la Billy Graham Evangelistic Association; en Luisiana, las familias del petróleo; en Nuevo México, las familias del Pérmico de los condados de Lea y Eddy.",
  "Endowments, fondos de emprendimiento y angel networks de universidades cristianas, empezando por las de ciudad hispanohablante: Baylor y su Baylor Angel Network, TCU, Abilene Christian y Dallas Baptist (Texas); Palm Beach Atlantic y Southeastern University (Florida); Samford (Alabama); Ouachita Baptist, Harding y John Brown University (Arkansas); Anderson University, Bob Jones y Furman (Carolina del Sur); Wake Forest, Davidson y Campbell (Carolina del Norte); Colorado Christian University; Louisiana Christian University; University of the Southwest (Hobbs, Nuevo México).",
  ...
  "Redes de empresarios y CEOs cristianos, que es donde están los angels sin página web: C12 Group (sede en Fort Worth, capítulos en los doce estados), Convene, Halftime Institute (Dallas), Kingdom Advisors (Atlanta), Faith Driven Investor y Faith Driven Entrepreneur (Atlanta) con sus grupos locales, su podcast y su directorio, y el Acton Institute. En todos ellos, filtrá por los miembros hispanos.",
